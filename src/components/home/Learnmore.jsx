...
const Learnmore = ({ cont, user, setCos, setUser, sorry, error }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div>
        <div className="d-flex jbtw col-md-7 col-lg-5 mx-auto px-2 mt-5">
          <div className="w-100 mt-5">
            <Talk
              bg={true}
              a={`Oops ! Welcome ,  to our Learn more section `}
